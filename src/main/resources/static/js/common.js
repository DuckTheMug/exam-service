const commonAjaxRequest = function ($ele, successFunc, errorFunc, failFunc, endFunc) {
...
const commonAjaxRequestParams = function ($ele, params, successFunc, errorFunc, failFunc, endFunc) {
